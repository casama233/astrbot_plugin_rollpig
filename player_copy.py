...
PLAYER_COPY: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "help.group.eat_target": "每群 {attempts} 口；{success}% 吃到 / {escape}% 溜走 / {backlash}% 反噬；最多成功 {meals} 顿",
        "help.group.random_eat": "随机挑一位目前可吃的群友",
        "help.group.eat_status": "查看今日胃口、成功次数与实际三段概率",
        ...
        "help.mechanic.reservation": "没抽猪先埋伏；/添柴 或 /烤群友 都能加入",
        "help.mechanic.appetite_title": "群友胃口",
        "help.mechanic.appetite": "每群每天 {attempts} 口、最多成功 {meals} 顿；熟食目标成功率 +{cooked}%",
        "help.mechanic.protection_title": "次日保护",
        "help.mechanic.protection": "昨天被烤太狠，今天普通群烤／吃会被拦",
        "help.mechanic.eat_protection_title": "餐后观察期",
        "help.mechanic.eat_protection": "昨天在同群被成功吃过，今天默认不再端上桌",
