...
# Help cards share Simplified display copy; retain the supported locale aliases.
_HELP_COPY: dict[str, str] = {
    ...
    "help.mechanic.reservation": "最多{participants}人；/烤群友加入不扣格",
