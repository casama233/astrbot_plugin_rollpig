...
PLAYER_COPY: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "help.group.oven_refill": "烤太猛沒火了？發起全群添柴；發起人先塞第 1 把",
        "help.group.oven_support": "補貨輪次中，每位今天在本群養過豬的群友可添柴一次",
        "help.group.firewood_router": "補貨進行中時裸 /添柴 支持補貨；沒有補貨且只有一張預約時可直接蹲鍋，多張預約請 @目標",
        ...
        "help.mechanic.ex_growth_title": "EX 成長｜同一隻豬，抽熟了會進化",
        ...
        "help.mechanic.group_refill_title": "群體補貨｜烤太猛就一起添柴",
        "help.mechanic.group_refill": "大家添柴達到門檻後，今天活躍群友各恢復 1 格 Charge",
        "help.mechanic.reservation_title": "預約烤豬｜人沒到，鍋先熱",
        "help.mechanic.reservation": "目標沒抽豬可先埋伏，最多 {participants} 人蹲鍋；可 /添柴 @目標 加入，再次 /烤群友 @同一目標 也兼容",
    ...
    "zh-CN": {
        ...
        "help.group.oven_refill": "烤太猛没火了？发起全群添柴；发起人先塞第 1 把",
        "help.group.oven_support": "补货轮次中，每位今天在本群养过猪的群友可添柴一次",
        "help.group.firewood_router": "补货进行中时裸 /添柴 支持补货；没有补货且只有一张预约时可直接蹲锅，多张预约请 @目标",
        ...
        "help.mechanic.ex_growth_title": "EX 成长｜同一只猪，抽熟了会进化",
        ...
        "help.mechanic.group_refill_title": "群体补货｜烤太猛就一起添柴",
        "help.mechanic.group_refill": "大家添柴达到门槛后，今天活跃群友各恢复 1 格 Charge",
        "help.mechanic.reservation_title": "预约烤猪｜人没到，锅先热",
        "help.mechanic.reservation": "目标没抽猪可先埋伏，最多 {participants} 人蹲锅；可 /添柴 @目标 加入，再次 /烤群友 @同一目标 也兼容",
