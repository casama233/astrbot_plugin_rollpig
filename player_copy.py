...
PLAYER_COPY: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "help.group.oven_refill": "發起本群今日協作補貨；發起者自動添第一把柴",
        "help.group.oven_support": "今日在本群參與過 RollPig 的群友每輪可添柴一次",
        ...
        "help.mechanic.group_refill": "大家添柴達成門檻後，今日活躍玩家統一恢復 +1 格能量",
        "help.mechanic.reservation_title": "預約烤豬",
        "help.mechanic.reservation": "未抽目標可提前埋伏，最多 {participants} 人一起添柴；後續再次 /烤群友 @同一目標即可加入",
    ...
    "zh-CN": {
        ...
        "help.group.oven_refill": "发起本群今日协作补货；发起者自动添第一把柴",
        "help.group.oven_support": "今日在本群参与过 RollPig 的群友每轮可添柴一次",
        ...
        "help.mechanic.group_refill": "大家添柴达成门槛后，今日活跃玩家统一恢复 +1 格能量",
        "help.mechanic.reservation_title": "预约烤猪",
        "help.mechanic.reservation": "未抽目标可提前埋伏，最多 {participants} 人一起添柴；后续再次 /烤群友 @同一目标即可加入",
