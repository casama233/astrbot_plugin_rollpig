...
PLAYER_COPY: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "help.group.reservation_firewood": "加入本群待結算預約；只有一張時直接添柴，多張時請 @目標；主廚已算 1 人",
        ...
        "help.mechanic.reservation": "未抽目標可提前埋伏，最多 {participants} 人添柴",
    ...
    "zh-CN": {
        ...
        "help.group.reservation_firewood": "加入本群待结算预约；只有一张时直接添柴，多张时请 @目标；主厨已算 1 人",
        ...
        "help.mechanic.reservation": "未抽目标可提前埋伏，最多 {participants} 人添柴",
