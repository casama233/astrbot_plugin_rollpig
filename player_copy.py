...
PLAYER_COPY: dict[str, dict[str, str]] = {
    "zh-TW": {
        ...
        "help.mechanic.reservation": "目標沒抽豬可先埋伏，最多 {participants} 人蹲鍋；可 /添柴 @目標 加入，沒有補貨且只有一張預約時裸 /添柴 也能進場",
    ...
    "zh-CN": {
        ...
        "help.mechanic.reservation": "目标没抽猪可先埋伏，最多 {participants} 人蹲锅；可 /添柴 @目标 加入，没有补货且只有一张预约时裸 /添柴 也能进场",
