(() => {
  ...
  if (document.readyState === 'loading') {
    document.write(
      '<script src="./ui-feedback-core.js?v=3.0.2"><\/script>' +
      '<script src="./ui-enterprise.js?v=3.0.2"><\/script>' +
      '<script src="./ui-analytics.js?v=3.0.2"><\/script>'
    );
    return;
  }
