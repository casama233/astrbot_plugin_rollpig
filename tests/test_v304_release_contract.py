...
def test_v304_release_contract_and_analytics_assets():
    ...
    assert 'AstrBot-RollPig/3.0.4' in main
    assert 'AstrBot-RollPig-Safe-Updater/3.0.4' in updater
    ...
    assert "const ASSET_VERSION = '3.0.4'" in loader
