...
def test_v302_release_contract_and_analytics_assets():
    ...
    assert 'version: "3.0.2"' in metadata
    assert 'AstrBot-RollPig/3.0.2' in main
    assert 'AstrBot-RollPig-Safe-Updater/3.0.2' in updater
    ...
    assert './ui-feedback.js?v=3.0.2' in page
    assert "const ASSET_VERSION = '3.0.2'" in loader
