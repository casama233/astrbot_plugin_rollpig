...
def test_v301_release_contract_and_analytics_assets():
    ...
    assert 'AstrBot-RollPig/3.0.1' in main
    assert 'AstrBot-RollPig-Safe-Updater/3.0.1' in updater
    ...
    assert './ui-feedback.js?v=3.0.1' in page
    assert "const ASSET_VERSION = '3.0.1'" in loader
